...
Alternatively, the =gc-maybe-opportunistic-mode= employs an "opportunistic" strategy by briefly raising the GC threshold for the functions listed in =gc-maybe-opportunistic-raise= and by triggering GC on focus changes.
...
(use-package gc-maybe
  ...
  ;; Or enable the alternative strategy mode
